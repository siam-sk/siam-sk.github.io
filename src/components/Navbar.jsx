...
const Navbar = ({ theme, toggleTheme }) => {
  ...
  const navLinks = (
    <>
      {navItems.map((item) => (
        ...
        >
          <a className="text-base font-medium transition-colors duration-300 block px-3 py-2">
            {item}
          </a>
          {hoveredLink === item && (
            <motion.div
  ...
  return (
    <motion.div
      ...
      className="navbar sticky top-0 z-50 bg-base-100/80 backdrop-blur-lg shadow-md border-b border-base-200/50 px-4 sm:px-8"
    >
